...
* `ktv_player` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `ktv-player` - executable or bundle name on disk.
* `ktv-player` - display name shown in window titles and about app dialogs.
