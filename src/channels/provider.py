...
class ChannelProvider:
    ...
    def get_all_channels(self) -> List[Dict]:
        ...
        channels = []
        try:
            # 1. Download and parse directly from URL using m3u-parser
            parser = M3uParser(timeout=15)
            parser.parse_m3u(self.MASTER_PLAYLIST_URL)
            
            # 2. Format the data to perfectly match your old UI structure
