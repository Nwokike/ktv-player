...
channels = [
    ...
    ChannelData(
        name="SBT Ⓨ",
        url="https://www.youtube.com/watch?v=ABVQXgr2LW4",
    ...
    ChannelData(
        name="RBC Ⓨ",
        url="https://www.youtube.com/watch?v=oUdd3CsxYaE",
    ...
    ChannelData(
        name="ISTV",
        url="https://video08.logicahost.com.br/istvnacional/srt.stream/istvnacional.m3u8",
