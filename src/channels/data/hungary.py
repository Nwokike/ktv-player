...
channels = [
    ChannelData(
        name="M1 Hiradó Ⓨ",
        url="https://www.youtube.com/@M1-Hirado/live",
    ...
    ChannelData(
        name="RTL Klub",
        url="https://cdn.mediaklikk.org:443/rtl/00wMyEjM5UTM",
    ...
    ChannelData(
        name="TV2",
        url="https://cdn.mediaklikk.org:443/tv2/00wMyEjM4UTM",
    ...
    ChannelData(
        name="Hír TV",
        url="https://onlinestream.live/play.m3u?id=4740&ext=.m3u",
    ...
    ChannelData(
        name="Fix TV",
        url="https://fixhd.tv:8082/fix/1080i/playlist.m3u8",
    ...
    ChannelData(
        name="EWTN TV",
        url="https://hls.iptvservice.eu/hls/ewtn-hd.m3u8",
    ...
    ChannelData(
        name="Apostol TV",
        url="https://live.apostoltv.hu/live/playlist.m3u8",
    ...
    ChannelData(
        name="MUSICPlus",
        url="http://s02.diazol.hu:10192/stream.m3u8",
        logo="",
        group="Hungary",
        country_code="HU",
        epg_id="MUSICPlus.hu",
    ...
    ChannelData(
        name="Radio 1 Ⓨ",
        url="https://www.youtube.com/watch?v=I8dnZoF1nOE",
        logo="",
        group="Hungary",
        country_code="HU",
        epg_id="",
    ...
    ChannelData(
        name="Oxygen Music",
        url="https://oxygenmusic.hu:2443/hls/oxygenmusic.m3u8",
        logo="",
        group="Hungary",
        country_code="HU",
        epg_id="",
    ...
    ChannelData(
        name="Izaura TV",
        url="http://78.109.104.240:8000/play/a0ch/index.m3u8?HasBahCa.m3u8",
        logo="https://onlinestream.live/logos/6141.png",
        group="Hungary",
        country_code="HU",
        epg_id="IzauraTV.hu",
    ...
    ChannelData(
        ...
        url="https://www.youtube.com/channel/UC4Ct8gIf9f0n4mdyGsFiZRA/live",
    ...
    ChannelData(
        ...
        url="https://plenaris.parlament.hu:446/edgelive/smil:mkogyplen.smil/playlist.m3u8",
        logo="",
        group="Hungary",
        country_code="HU",
        epg_id="",
    ...
    ChannelData(
        ...
        url="https://tab.parlament.hu:446/edgelive/smil:mkogytab.smil/playlist.m3u8",
        logo="",
        group="Hungary",
        country_code="HU",
        epg_id="",
    ...
    ChannelData(
        name="Budakalász",
        url="https://stream.streaming4u.hu/TVBudakalasz/tracks-v1a1/mono.m3u8",
    ...
    ChannelData(
        name="Hatoscsatorna",
        url="rtmp://lpmedia.hu:1935/Hatoscsatorna/livestream",
    ...
    ChannelData(
        name="Komlos TV",
        url="https://stream.streaming4u.hu/KomlosTV/tracks-v1a1/mono.m3u8",
    ...
    ChannelData(
        name="Ózdi Városi TV",
        url="https://stream.unrealhosting.hu:443/hls/ozdtv/live.m3u8",
    ...
    ChannelData(
        name="Pannon RTV",
        url="https://stream.unrealhosting.hu:443/hls/pannonrtv/live.m3u8",
    ...
    ChannelData(
        name="VTV Füzesabony",
        url="https://stream.unrealhosting.hu:443/hls/ftv/live.m3u8",
    ...
    ChannelData(
        ...
        url="https://citytv.hu/playlist.m3u8",
    ...
    ChannelData(
        name="FehérvárTV",
        url="https://cloudfront44.lexanetwork.com:1344/freerelay/fehervartv.sdp/playlist.m3u8?key=EWSj2",
    ...
    ChannelData(
        name="Halom TV",
        url="rtmp://212.92.13.108/live/livestream1",
    ...
    ChannelData(
        name="Kapos TV",
        url="https://cloudfront63.lexanetwork.com:1344/relay01/livestream004.sdp/playlist.m3u8",
    ...
    ChannelData(
        name="Zugló TV",
        url="https://cloudfront44.lexanetwork.com:1344/freerelay/zuglotv.sdp/playlist.m3u8",
    ...
    ChannelData(
        name="Tisza TV",
        url="https://www.tiszatv.hu/onlinetv/tiszatv_1.m3u8",
    ...
    ChannelData(
        ...
        url="http://78.47.126.198:5080/LiveApp/streams/902003217052313577741820.m3u8?token=null",
    ...
    ChannelData(
        name="Miskolc TV",
        url="https://video.mhzrt.hu/live/mitv/playlist.m3u8",
    ...
    ChannelData(
        ...
        url="https://cloudfront44.lexanetwork.com:1344/relay01/broadcast002.sdp/playlist.m3u8",
    ...
    ChannelData(
        name="Berente TV",
        url="https://stream.streaming4u.hu/BerenteTV/index.m3u8",
        logo="",
        group="Hungary",
        country_code="HU",
        epg_id="",
    ...
    ChannelData(
        ...
        url="https://cloudfront44.lexanetwork.com:1344/freerelay/bpetv.sdp/playlist.m3u8",
        logo="",
        group="Hungary",
        country_code="HU",
        epg_id="",
    ...
    ChannelData(
        name="Héviz TV",
        url="https://cloudfront44.lexanetwork.com:1344/relay03/livestream003.sdp/playlist.m3u8",
        logo="",
        group="Hungary",
        country_code="HU",
        epg_id="",
    ...
    ChannelData(
        ...
        url="https://cloudfront44.lexanetwork.com:1344/relay01/broadcast007.sdp/playlist.m3u8",
        logo="",
        group="Hungary",
        country_code="HU",
        epg_id="",
    ...
    ChannelData(
        name="Kanizsa TV",
        url="https://cloudfront44.lexanetwork.com:1344/freerelay/kanizsavtv.sdp/playlist.m3u8",
        logo="",
        group="Hungary",
        country_code="HU",
        epg_id="",
    ...
    ChannelData(
        name="Líceum TV",
        url="http://193.225.32.62:8890/live.m3u8",
        logo="",
        group="Hungary",
        country_code="HU",
        epg_id="",
    ...
    ChannelData(
        name="M2 / Petőfi TV",
        url="https://c201-node61-cdn.connectmedia.hu/110102/7184521041cf54cee9c6548e8d0ba377/64117799/index.m3u8",
    ...
    ChannelData(
        name="M4 Sport",
        url="https://c401-node62-cdn.connectmedia.hu/110110/5dd8dc6d853c9b7f94db85646ed44326/641177e3/index.m3u8",
    ...
    ChannelData(
        name="M5 Hungary",
        url="http://152.66.115.226:33390/bysid/201",
    ...
    ChannelData(
        name="Duna TV",
        url="http://152.66.115.226:33391/bysid/102",
