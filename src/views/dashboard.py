...
class DashboardView(ft.Container):
    def __init__(self, on_play: callable):
        ...
        self.page_ref = ft.Ref[ft.Page]()

        # Dialog for adding content
        self.dialog = self.build_add_dialog()
    ...
    def build_add_dialog(self):
        async def handle_add(_):
            ...
            if name and url:
                ...
                self.page.update()
                # Trigger reload via page
                if hasattr(self.page, "load_channels"):
                    await self.page.load_channels()
    ...
    def build(self):
        ...
        return ft.Column([
                ...
                [
                    ft.ExpansionTile(
                        ...
                        controls=[
                            ...
                            ) for c in channels if self.search_query.lower() in c.get('name', '').lower()
                        ]
            ...
            ) if self.selected_tab < 2 else self.build_custom_tab(),
            ...
            ft.Container(
                content=ft.Column([
                    ...
                    ft.FilledButton(
                        ...
                        on_click=lambda _: self.page.launch_url("https://github.com/iptv-org/iptv"),
                        style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=10))
                    )
                ], horizontal_alignment=ft.CrossAxisAlignment.CENTER),
                padding=10,
                alignment=ft.Alignment(0, 0),
                visible=(self.selected_tab < 2)
            )
